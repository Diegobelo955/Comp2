import exceções.tamanhoExcedidoException;
import exceções.userNotFoundException;
...
public class TuiterLiteTest {
    ...
    public void testeAutorDoTuite() {
        Tuite<?> tuite = null;
        try {
            tuite = tuiterLite.tuitarAlgo(usuario, "Testando");
    ...
    public void testeAnexo() {
        ...
        Tuite<Object> tuite = null;
        try {
            tuite = (Tuite<Object>) tuiterLite.tuitarAlgo(usuario, "Testando");
        } catch (tamanhoExcedidoException e) {
            e.printStackTrace();
        } catch (userNotFoundException e) {
            System.out.println("Usuário não encontrado");
    ...
    public void testeApenasUmTipoPermitidoComoAnexo() {
        ...
        Tuite<Image> tuite = null;
        try {
            tuite = tuiterLiteQueAceitaApenasImagensComoAnexo.tuitarAlgo(usuario, "Testando");
        } catch (tamanhoExcedidoException e) {
            e.printStackTrace();
        } catch (userNotFoundException e) {
            System.out.println("Usuário não encontrado");
    ...
    public void testeHashtags() {
        ...
        Tuite<?> tuite = null;
        try {
            tuite = tuiterLite.tuitarAlgo(usuario, "#LAB5 Testando algo com #hashtag ao longo... #teste");
        } catch (tamanhoExcedidoException e) {
            e.printStackTrace();
        } catch (userNotFoundException e) {
            System.out.println("Usuário não encontrado");
